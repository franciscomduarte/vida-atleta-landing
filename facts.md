...
- Links oficiais verificados em 2026-09-25: site da CBDA https://www.cbda.org.br/; redes: Instagram cbdaoficial, Facebook cbdaoficial, X (Twitter) CBDAoficial, YouTube c/TVCBDAOFICIAL. O site da BigMídia NÃO foi confirmado (bigmidia.com mostra página de teste do servidor); lojas (Google Play/App Store) e URLs públicas de Termos/Privacidade do app ainda não existem: a landing os exibe como "Em breve"/na tela de acesso do app.
