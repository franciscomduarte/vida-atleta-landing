...
- Links oficiais (2026-09-25): site da CBDA https://www.cbda.org.br/; redes: Instagram cbdaoficial, Facebook cbdaoficial, X (Twitter) CBDAoficial, YouTube c/TVCBDAOFICIAL. Informados pelo responsável do projeto e verificados no ar (HTTP 200): site da BigMídia https://bigmidia.com/; Google Play https://play.google.com/store/apps/details?id=com.bigmidia.vidaatleta.cbda&hl=pt_BR (mesmo pacote do app); App Store https://apps.apple.com/br/app/vida-atleta/id1483091888 (BIG MIDIA LTDA). O app já está publicado nas lojas e a nova versão chega como atualização (em fase de lançamento). URLs públicas de Termos/Privacidade do app ainda não existem: a landing os exibe como "na tela de acesso do app".
