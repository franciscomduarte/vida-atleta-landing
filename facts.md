...
## Documento institucional da CBDA (CBDA_transformacao_digital_revisado.docx, fornecido pelo responsável do projeto; cópia do texto em cbda-transformacao-digital.txt)
- Natureza: "O novo Vida Atleta, em fase de lançamento, é a porta de entrada de uma transformação" da CBDA; "integrado ao ecossistema CBDA e ao Sistema de Gestão Esportiva (SGE)"; "a face mais visível de um movimento". A transformação é "conduzida institucionalmente pela CBDA", sob a atual diretoria, com soluções propostas e desenvolvidas pela BigMídia, "responsável pelo SGE". Isto RESOLVE a decisão de natureza: o Vida Atleta é o aplicativo da CBDA (canal oficial). Uso do escudo/logo CBDA como arte segue pendente de aprovação.
- Escopo citado para o app: calendário, eventos, programas de provas, séries, raias, parciais, resultados, rankings, recordes, clubes e atletas inscritos, notícias e boletins oficiais. TENSÃO: o documento cita rankings e "evolução de cada disputa", mas no produto real rankings estão em prévia interna (bloqueados) e não há evolução do atleta; a landing NÃO promove rankings nem evolução.
- Públicos citados: atletas, famílias, treinadores, clubes, federações e torcedores.
- Declarações do documento usáveis na landing: a informação "passa a chegar à comunidade com mais velocidade, contexto e facilidade de acesso"; encontrar "em poucos passos a próxima competição, a prova, a raia, o resultado"; os resultados "chegam com mais agilidade aos canais oficiais e ao Vida Atleta"; SGE (BigMídia) "presente na gestão de 28 confederações e em uma base com mais de 1,5 milhão de atletas cadastrados" (número declarado pelo documento; confirmar antes de publicar).
- Entregas da nova era digital citadas: quarta versão do software de gestão de competições de natação (integração com placares eletrônicos e telão); novo MAR para águas abertas (aplicação web instalável, offline, sincroniza com o SGE, QR Code); novo sistema de inscrições e competições do polo aquático (em testes); área de estatísticas e inteligência esportiva; início da integração do SGE com a inteligência de performance; novo site da CBDA e novos sites das federações; suporte exclusivo (help desk) para a CBDA; ferramentas gratuitas para cada federação estadual.
- Links oficiais (2026-09-25): site da CBDA https://www.cbda.org.br/; redes: Instagram cbdaoficial, Facebook cbdaoficial, X (Twitter) CBDAoficial, YouTube c/TVCBDAOFICIAL. Informados pelo responsável do projeto e verificados no ar (HTTP 200): site da BigMídia https://bigmidia.com/; Google Play https://play.google.com/store/apps/details?id=com.bigmidia.vidaatleta.cbda&hl=pt_BR (mesmo pacote do app); App Store https://apps.apple.com/br/app/vida-atleta/id1483091888 (BIG MIDIA LTDA). O app está publicado nas lojas e a NOVA VERSÃO JÁ ESTÁ LIBERADA (confirmado pelo responsável em 2026-09-26): quem já tinha o app atualiza; a landing NÃO deve mais dizer "em fase de lançamento" nem "chegando". URLs públicas de Termos/Privacidade do app ainda não existem: a landing os exibe como "na tela de acesso do app".
- Número institucional CONFIRMADO pelo responsável do projeto em 2026-09-25 (vem do documento de transformação digital da CBDA): o SGE, da BigMídia, está presente na gestão de 28 confederações e em uma base com mais de 1,5 milhão de atletas cadastrados. Usável na landing.

## Fotografias (Pexels, licença Pexels: uso comercial livre)
